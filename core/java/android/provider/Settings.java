...
public final class Settings {
    ...
    */
    ...
    public static final class System extends NameValueTable {
         ...
         * orientation.  If 0, it will not be used; if 1, it will be used by default unless explicitly
         * disabled by the application.
         */
        public static final String AUTOROTATE_LOCKSCREEN = "autorotate_lockscreen";
